...
module.exports = {
  ...
  handle: async ({
    ...
    if (!args.length || !args[0]) {
      return sendWarningReply("Por favor, menciona a un usuario para promover.");
    }

    if (!(await isBotAdmin({ remoteJid, socket }))) {
      return sendWarningReply(
        "¡Necesito ser administrador del grupo para promover a otros miembros!"
      );
    }
    ...
    try {
      ...
      await sendErrorReply("Ocurrió un error al intentar promover al usuario.");
    }
  },
};