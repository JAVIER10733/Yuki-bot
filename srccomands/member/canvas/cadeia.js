...
module.exports = {
  name: "cadena",
  description:
    "Genero una imagen como si la persona estuviera en la cárcel con la imagen que envíes",
  commands: ["cadena", "jail"],
  usage: `${PREFIX}cadena (marca la imagen) o ${PREFIX}cadena (responde a la imagen)`,
  /**
  ...
  handle: async ({
    ...
    if (!isImage) {
      throw new InvalidParameterError(
        "Debes marcar una imagen o responder a una imagen"
      );
    }
